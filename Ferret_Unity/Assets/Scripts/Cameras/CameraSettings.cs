...
public class CameraSettings : MonoBehaviour
{
    ...
    void Reset()
    {
        ...
        /*PlayerManager playerManager = FindObjectOfType<PlayerController>();
        if (playerManager != null && playerManager.name == "Ellen")
        {
            if (playerManager.cameraSettings == null)
                playerManager.cameraSettings = this;
        }*/
    }
